    ...
    describe("Electron", () => {
        ...
        describe("Windows", () => {
            ...
            it("renders icon, menu, title, children and window controls", () => {
                ...
                expect(wrapper.find(".btn-window-minimize").exists()).toBe(
                    true
                );
                expect(wrapper.find(".btn-window-maximize").exists()).toBe(
                    true
                );
            ...
            it("calls menu item click method when selected", () => {
                ...
                expect(expectedMenuItem.click).toBeCalledWith(
                    expectedMenuItem,
                    electronCurrentWindow
                );
            });
            ...
            it("does not render maximize button when window is maximized", () => {
                ...
                expect(wrapper.find(".btn-window-restore").exists()).toBe(
                    false
                );
            ...
            it("Updates title when props change", () => {
                ...
                expect(wrapper.find(".title-bar-main").text()).toEqual(
                    expectedTitleString
                );
                expect(electronCurrentWindow.setTitle).toBeCalledWith(
                    expectedTitleString
                );
            });
